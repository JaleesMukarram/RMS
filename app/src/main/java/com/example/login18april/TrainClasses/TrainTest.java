...
//        trainStations[0] = new TrainStation("Rawalpindi old Station", "Äli Iqbal", "Rawalpindi");
//        trainStations[1] = new TrainStation("Lahore Station", "Arif Saif", "Lahore");
//        trainStations[2] = new TrainStation("Main Karachi Station", "Sohaib dawood", "Karachi");
//
//
