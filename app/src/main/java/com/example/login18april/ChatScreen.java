            ...
            public void onClick(View v) {
                ...
                if (chatData.length() == 0) {
                    ...
                    try {
                        ...
                        Chat c = new Chat("JaleesMukarram",UsernameName, new Date(), chatData);
                        chatsList.add(c);

                        SendMessage.setText("");

                        String referenceToSpecificChat = "AdminToClientChat" + "/" + "JaleesMukarramTo" + UsernameName;
                        ...
                        ReferenceNode.child(key).child("to").setValue("JaleesMukarram");
    ...
    public void AddChattoDataBase(){
        ...
        if (chatData.length() == 0) {
            ...
            try {
                ...
                SendMessage.setText("");
                Intent it = getIntent();
                String referenceToSpecificChat = "JaleesMukarram" + "To" + UsernameName;


                FirebaseDatabase OnlineDatabase = FirebaseDatabase.getInstance();
                String initialReference = "AdminToClientChat" + "/" + "JaleesMukarramTo" + UsernameName;
