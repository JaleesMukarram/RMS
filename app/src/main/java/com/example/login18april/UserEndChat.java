...
//        recyclerView.getLayoutManager().scrollToPosition(chatsList.size()-1);
    ...
    public void AddChattoDataBase() {
        ...
        if (chatData.length() == 0) {
            ...
            try {
                Chat c = new Chat(getUsernameFromLocaFile(), "JaleesMukarram", new Date(), chatData);
                chatsList.add(c);
...
//                String username = it.getStringExtra("username");
                ...
                String referenceToSpecificChat = "AdminToClientChat" + "/" + "JaleesMukarramTo" + getUsernameFromLocaFile();
    ...
    public void ImportOnlineChat() {
        ...
        OnlineDatabase = FirebaseDatabase.getInstance();
        String initialReference = "AdminToClientChat" + "/" + "JaleesMukarramTo" + getUsernameFromLocaFile();
