...
public class AddClientBooking extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    private void addStationtoOnlineDatabase() {
        ...
        String stationName = "Karachi Station";
        String stationCityName = "Karachi";
        String[] TrainStopsAtStation = {"Awami Express", "Green Line"};
        String[] EmployeesName = {"Ali Abbass", "Saad Jameel", "Farooq Amjad"};
        String stationMaster = "Fawad Cheema";
